...
class ActorViewModel extends ViewModel
{
    ...
    public function actor()
    {
        return collect($this->actor)->merge([
            ...
            'biography', 'birthday', 'homepage', 'id', 'name', 'place_of_birth', 'profile_path', 'age'
        ]);
    }
    ...
    public function social()
    {
        return collect($this->social)->merge([
            ...
            'facebook_id', 'instagram_id', 'twitter_id', 'twitter', 'facebook', 'instagram'
        ]);
    }
    ...
    public function knownForMovies()
    {
        ...
        return collect($castMovies)->sortByDesc('popularity')->take(5)->map(function ($movie) {
            ...
            return collect($movie)->merge([
                ...
                'id', 'poster_path', 'title', 'name', 'popularity', 'media_type', 'linkToPage'
            ]);
        });
    }
    ...
    public function credits()
    {
        ...
        return collect($castMovies)->map(function ($movie) {
            ...
            return collect($movie)->merge([
                ...
                'release_date', 'first_air_date', 'title', 'name', 'character', 'media_type', 'release_year', 'cast',
                'credits', 'id', 'linkToPage'
            ]);
